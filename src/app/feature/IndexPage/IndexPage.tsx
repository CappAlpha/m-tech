...
import {
  ...
  heroBlock,
  form,
  aboutBlockTitle, aboutReviewSection,
  ourProjTitle, ProjectsArr,
  ourDirTitle, ourDirSection,
  IndustrySolutionTitle, IndustrySolutionImages,
...
export const IndexPage: FC = () => {
  return (
    <div className={styles.root}>
      ...
      <Projects title={ourProjTitle.title} projects={ProjectsArr} />
